...
class Model(object):
    ...
    def save(self, sess=None):
        ...
        save_path = saver.save(sess, "pixel2mesh/hitoshi_utils/hitoshi_checkpoint/%s.ckpt" % self.name)
    ...
    def load(self, sess=None):
        if not sess:
            raise AttributeError("TensorFlow session not provided.")
        saver = tf.train.Saver(self.vars)
        save_path = "pixel2mesh/hitoshi_utils/hitoshi_checkpoint/%s.ckpt" % self.name
