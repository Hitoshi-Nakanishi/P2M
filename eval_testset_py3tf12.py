...
from pixel2meshpy3tf12.cd_dist import nn_distance
sys.path.append('/notebooks/DockerShared/TensorFlowGPU/Pixel2Mesh/pixel2meshpy3tf12/external')
from tf_approxmatch import approx_match, match_cost

# Settings
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_string('data_list', 'pixel2meshpy3tf12/utils/test_list.txt', 'Data list path.')
