...
from pixel2meshpy2.models import GCN
from pixel2meshpy2.fetcher import *
from pixel2meshpy2.cd_dist import nn_distance
sys.path.append('/notebooks/DockerShared/TensorFlowGPU/Pixel2Mesh/pixel2meshpy2/external')
from tf_approxmatch import approx_match, match_cost

flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_string('data_list', 'pixel2meshpy2/utils/test_list.txt', 'Data list path.')
...
pkl = pickle.load(open('pixel2meshpy2/utils/ellipsoid/info_ellipsoid.dat', 'rb'))
